...
public class Task3 {
    public static void main(String[] args) {
        Teacher mTeacher = new Teacher("Ричард Сапогов","Матан");
        Teacher lTeacher = new Teacher("Татьяна Восьмиглазова", "Природоведение");
        Student st1 = new Student("Николай");
        Student st2 = new Student("Константин");


        mTeacher.evaluate(st1);
        mTeacher.evaluate(st2);

        lTeacher.evaluate(st1);
        lTeacher.evaluate(st2);
